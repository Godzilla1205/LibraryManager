...
<head>
	...
	@yield("datepicker")
	@yield("highcharts")
	<script src="{{asset('vendor/2.js')}}"></script>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
				<ul class="navbar-nav animate side-nav page-sider-menu">
					...
					<div class="collapse" id="menu1">
						<li class="nav-item @yield("fage-sider-menu6")">
							<a class="nav-link" href="pay.html" data-parent="#menu1"><i class="fa fa-tasks"></i><span>Mượn sách</span></a>
						</li>
						<li class="nav-item">
							<a class="nav-link @yield("fage-sider-menu7")" href="bill.html" data-parent="#menu1"><i class="fa fa-tasks"></i><span>Trả sách</span></a>
						</li>
					</div>
					<li class="nav-item @yield("fage-sider-menu10")">
						<a class="nav-link" href="statistical.html"><i class="fa fa-object-group"></i><span>Thống kê</span></a>
					</li>
				</ul>
