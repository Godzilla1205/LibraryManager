              ...
              <tbody>
                ...
                <tr class="tr-info">
                  ...
                  <td class="action-button">
                    <a class="btn btn-primary" href="{action('BookController getManagerBook_Edit',$reader['id'])}}"><i class="fa fa-edit"></i></a>
                    <a class="btn btn-danger" href="{action('BookController getManagerBook_Delete',$reader['id'])}}"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
                @endforeach
              </tbody>
